...
import com.junsionzhang.model.AuthTokenInfo;
import com.junsionzhang.model.User;
 
  
public class SpringRestClient {
  
    public static final String REST_SERVICE_URI = "http://localhost:8080/OAuth2";
     
    public static final String AUTH_SERVER_URI = "http://localhost:8080/OAuth2/oauth/token";
    ...
    private static HttpHeaders getHeadersWithClientCredentials(){
        ...
        while(ite.hasNext()){
        	Entry<String, List<String>> val = ite.next();
